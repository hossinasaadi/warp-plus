...
build() {
    ...
    if git clone https://github.com/hossinasaadi/warp-plus.git &&
        cd wireguard-go &&
        go build main.go &&
        chmod +x main &&
...
install() {
    ...
    if wget https://github.com/hossinasaadi/warp-plus/releases/download/v1.0.1-rc1/warp-android-arm64.9f90b7.zip &&
...
install_arm() {
    ...
    WARP_URL="https://github.com/hossinasaadi/warp-plus/releases/download/v1.0.1-rc1/warp-linux-$ARCH.9f90b7.zip"
